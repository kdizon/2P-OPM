...
#set parameters
y_step_size = 0.08667 #um
pixelsize = 0.08667 #um

bin = 1
slices_per_volume = "z"
channels = 1 # note that only 2 channels work; For 3 channels (and beyond), this code needs editing
...
class transformer:
    ...
    angle = 45 #be careful here. It could be that the angle is actually -45deg, with respect to reference coordinates in the code
    interpolation = 1
    images = ()
    max_GPU_memory = 1 #GB
